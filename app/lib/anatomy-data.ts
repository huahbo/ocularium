...
const EYE_LAYERS: OrganLayer[] = [
      ...
      { id: "VH_M_palpebral_conjunctiva_of_upper_eyelid_L", label: "Palpebral Conjunctiva (Upper)", color: "#e08072" },
      { id: "VH_M_palpebral_conjunctiva_of_lower_eyelid_L", label: "Palpebral Conjunctiva (Lower)", color: "#e08072" },
...
export const organs: Organ[] = [
  {
    ...
    anteriorHotspots: [
      { id: "tm", label: "Trabecular Meshwork", detail: "Primary outflow resistance", position: [0.9, 0, 1.33], color: "#c9a86a" },
      { id: "jct", label: "Juxtacanalicular Tissue", detail: "Innermost TM layer", position: [0.96, 0, 1.33], color: "#e8c39a" },
      { id: "sc", label: "Schlemm's Canal", detail: "Circumferential drainage channel", position: [1.03, 0, 1.33], color: "#7fa88a" },
      { id: "cc", label: "Collector Channel", detail: "Drains to aqueous veins", position: [1.2, 0, 1.33], color: "#6393d8" },
    ],
    anteriorLayerIds: [
      "VH_M_cornea_L",
...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { en: "Collector Channels", zh: "房水集合管", group: "Anterior segment" },
